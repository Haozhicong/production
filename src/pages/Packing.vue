  ...
  <div>
    ...
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>订单包装</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 表格操作 -->
    <div class="container">
      <div class="btn_tools">
        <el-row type="flex">
          <el-col :span="12">
            <el-button @click="newPlanTure()" type="success">新建包装</el-button>
          </el-col>
    ...
    <!-- 新建生产计划弹出框 -->
    <el-dialog title="新建包装" :visible.sync="dialogVisible" width="70%">
      ...
      <div class="makeInput">
        <el-form :inline="true" :model="staffName" label-width="110px">
          ...
          <el-form-item label="包装方式">
            <el-input v-model="staffName.packingMethod"></el-input>
          </el-form-item>
      ...
      <div class="bot_btn" style="margin-top:15px">
        <el-button @click="submitInfo" type="success">提交包装信息</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    // 获取包装列表数据
    getTableData() {
      const url = `http://106.14.116.17/api/orderpack/list`;
      this.$axios
        .get(url, {
          params: {
    ...
    submitInfo() {
      ...
      const url = `http://106.14.116.17/api/orderpack/save`;
      this.$axios({
        url: url,
        method: "post",
        //发送格式为json
