  ...
  <div>
    ...
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>订单剪料</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 表格操作 -->
    <div class="container">
      <div class="btn_tools">
        <el-row type="flex">
          <el-col :span="12">
            <el-button @click="newPlanTure()" type="success">新建剪料</el-button>
          </el-col>
      ...
      <div class="table_data">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="materialColour" label="网料颜色"></el-table-column>
          <el-table-column prop="materialNum" label="网料数量(根)"></el-table-column>
          <el-table-column prop="materialWeight" label="网料重量"></el-table-column>
    ...
    <!-- 新建订单剪料弹出框 -->
    <el-dialog title="新建剪料计划" :visible.sync="dialogVisible" width="70%">
      <el-form ref="form" :inline="true" :model="form" label-width="110px">
        ...
        <div>
          ...
          <el-form-item label="网料颜色">
            <el-input v-model="form.materialColour"></el-input>
          </el-form-item>
          <el-form-item label="网料数量(根)">
            <el-input v-model="form.materialNum"></el-input>
          </el-form-item>
          <el-form-item label="网料重量">
            <el-input v-model="form.materialWeight"></el-input>
          </el-form-item>
    ...
    <!-- 编辑订单剪料弹出框 -->
    <el-dialog title="新建剪料计划" :visible.sync="editVisible" width="70%">
      <el-form ref="form" :inline="true" :model="form" label-width="110px">
        <div>
          <el-form-item label="订单编号">
...
export default {
  ...
  methods: {
    ...
    // 获取拉网列表数据
    getTableData() {
      const url = `http://106.14.116.17/api/ordercutting/list`;
      this.$axios
        .get(url, {
          params: {
    ...
    editClick(row) {
      ...
      this.form.materialColour = row.materialColour;
      this.form.materialNum = row.materialNum;
    ...
    editSubmit() {
      const url = `http://106.14.116.17/api/ordercutting/update`;
      this.$axios({
        url: url,
        method: "post",
        //发送格式为json
        ...
        if (res.data.code === 0) {
          ...
          this.form.materialColour = "";
          this.form.materialNum = "";
