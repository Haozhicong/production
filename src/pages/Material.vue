  ...
  <div>
    ...
    <div class="container">
      <div class="btn_tools">
        <el-row type="flex">
          <el-col :span="12">
            <el-button @click="newPlanTure" type="success">新建入库</el-button>
          </el-col>
        ...
        <el-table :data="tableData" border style="width: 100%">
          <el-table-column prop="warehousingTime" label="入库时间">
            <template slot-scope="scope">
              <span>{{ scope.row.warehousingTime | dateFormart('yyyy-MM-dd')}}</span>
            </template>
          </el-table-column>
          <el-table-column prop="materialWeight" label="原料重量(kg)"></el-table-column>
          <el-table-column prop="materialPackage" label="原料包数"></el-table-column>
    ...
    <!-- 新建生产计划弹出框 -->
    <el-dialog title="新建原料入库单" :visible.sync="dialogVisible" width="30%">
      <el-form ref="form" :model="form" label-width="110px">
        ...
        <el-form-item label="原料重量(kg)">
          <el-input v-model="form.materialWeight"></el-input>
        </el-form-item>
        <el-form-item label="原料包数">
